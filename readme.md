...
One programming assignment will be given during this course.
There is no strict deadline, but you must submit it at least one week before the exam.
The grade for programming assignment will be worth 20% towards your grade for this course.
The preferred way of submission is by email (include source code, executable file and program description - either as attachments or links to repositories for downloading them), but you can arrange transfer of files by USB flash drive or other digital media.
You should be prepared to give also a demonstration of your program.

New!!! Description of the problem for Programming project is available for download.
